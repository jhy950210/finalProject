    ...
    return (function (t) {
        ...
        function (t, e, n) {
            ...
            function a(t, e, n) {
                ...
                l(t),
                    ...
                    n && ((e -= u), (i = Math.floor(e / o.length)), (r = Math.floor(e - i * (o.length - 1)))),
            ...
            function _(t) {
                var e,
                    ...
                    i = [],
                    r = [];
                for ("string" == typeof t ? (r = t.split(/\s*,\s*/)) : "function" == typeof t ? (r = [t]) : ht.isArray(t) && (r = t), e = 0; e < r.length; e++)
                    ...
                    return (
                        ...
                        (t.prototype.intersect = function (e) {
                            ...
                            return (
                                ...
                                (null == n || null == i || n < i) && ((r = new t(n, i)), (r.isStart = this.isStart && n === this.startMs), (r.isEnd = this.isEnd && i === this.endMs)),
                                r
                            );
                        }),
                ...
                a = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.listenTo = function (t, e, n) {
                            if ("object" == typeof e) for (var i in e) e.hasOwnProperty(i) && this.listenTo(t, i, e[i]);
            ...
            function r(t, e, n) {
                ...
                return (
                    o.isMoment(p) || a.isNativeDate(p) || void 0 === p
                        ...
                        : ((i = !1),
                          (r = !1),
                          h ? (l.test(p) ? ((p += "-01"), (t = [p]), (i = !0), (r = !0)) : (d = u.exec(p)) && ((i = !d[5]), (r = !0))) : s.isArray(p) && (r = !0),
                          (c = e || i ? o.utc.apply(o, t) : o.apply(null, t)),
                          i ? ((c._ambigTime = !0), (c._ambigZone = !0)) : n && (r ? (c._ambigZone = !0) : h && c.utcOffset(p))),
                    (c._fullCalendar = !0),
                    c
                );
            }
                            ...
                            this.component.hitsNeeded(),
                                ...
                                e
                                    ? ((i = { left: s.getEvX(e), top: s.getEvY(e) }),
                                      (r = i),
                                      o && ((n = s.getOuterRect(o)), (r = s.constrainPoint(r, n))),
                                      (this.origHit = this.queryHit(r.left, r.top)),
                                      o && this.options.subjectCenter && (this.origHit && (n = s.intersectRects(this.origHit, n) || n), (r = s.getRectCenter(n))),
                    ...
                    return (
                        ...
                        (e.prototype.updateNowIndicator = function () {
                            this.isDatesRendered &&
                                this.initialNowDate &&
                                (this.unrenderNowIndicator(), this.renderNowIndicator(this.initialNowDate.clone().add(new Date().valueOf() - this.initialNowQueriedMs)), (this.isNowIndicatorRendered = !0));
                        }),
                    ...
                    return (
                        ...
                        (t.prototype.compareEventSegs = function (t, e) {
                            ...
                            return (
                                ...
                                r.compareByFieldSpecs(n.eventDef, i.eventDef, this.view.eventOrderSpecs, n.eventDef.miscProps, i.eventDef.miscProps)
                            );
                        }),
                        t
                    );
                    ...
                    return (
                        ...
                        (t.prototype.buildNewDateProfile = function (t, e) {
                            var n = t.start.clone(),
                                ...
                                o = !1;
                            return (
                                t.end && !this.clearEnd ? (i = t.end.clone()) : this.endDelta && !i && (i = e.getDefaultEventEnd(t.isAllDay(), n)),
                                this.forceTimed ? ((o = !0), n.hasTime() || n.time(0), i && !i.hasTime() && i.time(0)) : this.forceAllDay && (n.hasTime() && n.stripTime(), i && i.hasTime() && i.stripTime()),
                                this.dateDelta && ((o = !0), n.add(this.dateDelta), i && i.add(this.dateDelta)),
                ...
                a = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.bindHandlers = function () {
                            var t = s.default.get();
                            this.isGeneric
                                ? this.listenTo(i(document), { drag: this.handleMove, dragstop: this.endInteraction })
                                : this.isTouch
                ...
                s = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.updateDayTable = function () {
                            for (
                                var t, e, n, i = this, r = i.view, o = r.calendar, s = o.msToUtcMoment(i.dateProfile.renderUnzonedRange.startMs, !0), a = o.msToUtcMoment(i.dateProfile.renderUnzonedRange.endMs, !0), l = -1, u = [], d = [];
                                s.isBefore(a);

                            )
                                r.isHiddenDay(s) ? u.push(l + 0.5) : (l++, u.push(l), d.push(s.clone())), s.add(1, "days");
                        ...
                        (e.prototype.sliceRangeByRow = function (t) {
                            ...
                            for (e = 0; e < this.rowCnt; e++)
                                (n = e * s),
                                    ...
                                    (r = Math.ceil(r)),
                                    (o = Math.floor(o)),
                                    r <= o && d.push({ row: e, firstRowDayIndex: r - n, lastRowDayIndex: o - n, isStart: r === l, isEnd: o === u });
                            return d;
                        }),
                        ...
                        (e.prototype.renderHeadDateCellHtml = function (t, e, n) {
                            ...
                            return (
                                ...
                                '<th class="' +
                                    ...
                                    (n ? " " + n : "") +
                                    ">" +
                                    (a ? s.buildGotoAnchorHtml({ date: t, forceOff: o.rowCnt > 1 || 1 === o.colCnt }, i) : i) +
                                    "</th>"
                            );
                        }),
                    ...
                    return (
                        ...
                        (e.prototype.renderNumberCellHtml = function (t) {
                            ...
                            return s || this.cellWeekNumbersVisible
                                ? ((e = this.getDayClasses(t)),
                                  ...
                                  this.cellWeekNumbersVisible && t.day() === n && (r += i.buildGotoAnchorHtml({ date: t, type: "week" }, { class: "fc-week-number" }, t.format("w"))),
                                  s && (r += i.buildGotoAnchorHtml(t, { class: "fc-day-number" }, t.format("D"))),
                                  (r += "</td>"))
                                : "<td/>";
                        }),
                        ...
                        (e.prototype.renderMoreLink = function (t, e, n) {
                            ...
                            return r('<a class="fc-more"/>')
                                ...
                                .on("click", function (s) {
                                    ...
                                    "function" == typeof a && (a = i.publiclyTrigger("eventLimitClick", { context: o, args: [{ date: l.clone(), dayEl: d, moreEl: u, segs: p, hiddenSegs: h }, s, o] })),
                        ...
                        (e.prototype.resliceDaySegs = function (t, e) {
                            ...
                            for (n = 0; n < t.length; n++)
                                (i = t[n]),
                                    (o = i.footprint.componentFootprint.unzonedRange.intersect(c)) &&
                                        p.push(
                                            r.extend({}, i, {
                    ...
                    return (
                        ...
                        (e.prototype.renderHeadIntroHtml = function () {
                            ...
                            return this.colWeekNumbersVisible
                                ? '<th class="fc-week-number ' + t.calendar.theme.getClass("widgetHeader") + '" ' + t.weekNumberStyleAttr() + "><span>" + s.htmlEscape(this.opt("weekNumberTitle")) + "</span></th>"
                                : "";
                        }),
                        (e.prototype.renderNumberIntroHtml = function (t) {
                            var e = this.view,
                ...
                c = (function (t) {
                    function e(e, n) {
                        ...
                        return (
                            ...
                            i.opt("weekNumbers") &&
                                (i.opt("weekNumbersWithinDays") ? ((i.dayGrid.cellWeekNumbersVisible = !0), (i.dayGrid.colWeekNumbersVisible = !1)) : ((i.dayGrid.cellWeekNumbersVisible = !1), (i.dayGrid.colWeekNumbersVisible = !0))),
                            i.addChild(i.dayGrid),
                            (i.scroller = new a.default({ overflowX: "hidden", overflowY: "auto" })),
                            i
                        );
                    }
                    return (
                        ...
                        (e.prototype.updateSize = function (e, n, i) {
                            ...
                            t.prototype.updateSize.call(this, e, n, i),
                                ...
                                n ||
                                    ...
                                    (o.left || o.right) && (s.compensateScroll(l, o), (r = this.computeScrollerHeight(e)), this.scroller.setHeight(r)),
                    ...
                    return (
                        ...
                        (e.prototype.queue = function (t, e, n) {
                            ...
                            e && (i = this.waitsByNamespace[e]),
                                this.waitNamespace && (e === this.waitNamespace && null != i ? this.delayWait(i) : (this.clearWait(), this.tryStart())),
                ...
                p = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.buildGotoAnchorHtml = function (t, e, n) {
                            var i, r, s, u;
                            return (
                                o.isPlainObject(t) ? ((i = t.date), (r = t.type), (s = t.forceOff)) : (i = t),
                                (i = l.default(i)),
                            ...
                            return (
                                this.dateProfile.activeUnzonedRange.containsDate(t)
                                    ? (r.push("fc-" + a.dayIDs[t.day()]),
                                      ...
                                      (n = i.calendar.getNow()),
                                      t.isSame(n, "day") ? (r.push("fc-today"), !0 !== e && r.push(i.calendar.theme.getClass("today"))) : t < n ? r.push("fc-past") : r.push("fc-future"))
                    ...
                    return (
                        ...
                        (t.prototype.renderView = function (t) {
                            ...
                            this.freezeContentHeight(),
                                ...
                                this.view &&
                                    (this.view.get("businessHourGenerator") !== this.businessHourGenerator && this.view.set("businessHourGenerator", this.businessHourGenerator),
                            ...
                            (this.defaultAllDayEventDuration = o.duration(this.opt("defaultAllDayEventDuration"))),
                                ...
                                this.optionsManager.watch("buildingMomentLocale", ["?locale", "?monthNames", "?monthNamesShort", "?dayNames", "?dayNamesShort", "?firstDay", "?weekNumberCalculation"], function (e) {
                                    ...
                                    e.monthNames && (o._months = e.monthNames),
                                        ...
                                        null == r && "ISO" === i && (r = 1),
                                        null != r && ((n = Object.create(o._week)), (n.dow = r), (o._week = n)),
                ...
                s = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.buildCurrentRangeInfo = function (t, e) {
                            ...
                            return (
                                i.duration
                                    ? ((o = i.duration), (s = i.durationUnit), (a = this.buildRangeFromDuration(t, e, o, s)))
                                    : (n = this.opt("dayCount"))
                                    ? ((s = "day"), (a = this.buildRangeFromDayCount(t, e, n)))
                                    : (a = this.buildCustomVisibleRange(t))
                                    ? (s = r.computeGreatestUnit(a.getStart(), a.getEnd()))
                                    : ((o = this.getFallbackDuration()), (s = r.computeGreatestUnit(o)), (a = this.buildRangeFromDuration(t, e, o, s))),
                        ...
                        (t.prototype.buildRangeFromDuration = function (t, e, n, s) {
                            ...
                            return (
                                h || ((l = this.opt("dateIncrement")), l ? ((u = i.duration(l)), (h = u < n ? r.computeDurationGreatestUnit(u, l) : s)) : (h = s)),
        ...
        function (t, e, n) {
            function i(t) {
                ...
                return (
                    ...
                    e && ((e = "object" == typeof e ? o.extend({}, e) : {}), (n = e.start), null == n && (n = e.time), (i = e.duration), (r = e.stick), delete e.start, delete e.time, delete e.duration, delete e.stick),
                ...
                v = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.listenToExternalDrag = function (t, e, n) {
                            ...
                            (this.dragListener = new c.default(s, {
                                ...
                                hitOver: function (t) {
                                    ...
                                    i ? ((r = o.computeExternalDrop(i, u)), r ? ((e = new h.default(r.buildInstances())), (n = u.eventProps ? s.isEventInstanceGroupAllowed(e) : s.isExternalInstanceGroupAllowed(e))) : (n = !1)) : (n = !1),
                        ...
                        (e.prototype.computeExternalDrop = function (t, e) {
                            ...
                            return (
                                t.isAllDay && (e.startTime ? r.time(e.startTime) : r.stripTime()),
                                e.duration && (n = r.clone().add(e.duration)),
                                (r = i.applyTimezone(r)),
                                n && (n = i.applyTimezone(n)),
                                p.default.parse(o.extend({}, e.eventProps, { start: r, end: n }), new f.default(i))
                            );
                        }),
                        e
                    );
                        ...
                        (e.prototype.buildDragListener = function (t, e) {
                            ...
                            return (this.dragListener = new l.default(s, {
                                ...
                                hitOver: function (n, l, c) {
                                    ...
                                    g && v
                                        ? ((i = e ? r.computeEventStartResizeMutation(g, v, t.footprint) : r.computeEventEndResizeMutation(g, v, t.footprint)),
                                          i ? ((h = d.buildMutatedEventInstanceGroup(p.id, i)), (f = s.isEventInstanceGroupAllowed(h))) : (f = !1))
                                        : (f = !1),
                                        f ? i.isEmpty() && (i = null) : ((i = null), o.disableCursor()),
                                        i && (a.hideEventsWithId(t.footprint.eventDef.id), a.renderEventResize(s.eventRangesToEventFootprints(h.sliceRenderRanges(s.dateProfile.renderUnzonedRange, u)), t));
                                },
                                hitOut: function () {
                                    i = null;
                                },
                    ...
                    return (
                            ...
                            var g = (this.dragListener = new l.default(a, {
                                ...
                                hitOver: function (e, l, u) {
                                    ...
                                    t.hit && (u = t.hit),
                                        ...
                                        p && f ? ((i = o.computeEventDropMutation(p, f, h)), i ? ((v = c.buildMutatedEventInstanceGroup(h.id, i)), (y = s.isEventInstanceGroupAllowed(v))) : (y = !1)) : (y = !1),
                        ...
                        (e.prototype.computeEventDateMutation = function (t, e) {
                            var n,
                                ...
                                u = !1;
                            return (
                                t.isAllDay !== e.isAllDay && ((a = !0), e.isAllDay ? ((u = !0), r.stripTime()) : (l = !0)),
                ...
                f = (function (t) {
                    function e(e, n) {
                        ...
                        return (
                            ...
                            i.opt("allDaySlot") && ((i.dayGrid = i.instantiateDayGrid()), i.addChild(i.dayGrid)),
                            (i.scroller = new d.default({ overflowX: "hidden", overflowY: "auto" })),
                            i
                        );
                    }
                    return (
                        ...
                        (e.prototype.updateSize = function (e, n, i) {
                            var r, o, s;
                            if ((t.prototype.updateSize.call(this, e, n, i), (this.axisWidth = u.matchCellWidths(this.el.find(".fc-axis"))), !this.timeGrid.colEls))
                                return void (n || ((o = this.computeScrollerHeight(e)), this.scroller.setHeight(o)));
                            var a = this.el.find(".fc-row:not(.fc-scroller *)");
                            this.timeGrid.bottomRuleEl.hide(),
                                this.scroller.clear(),
                                u.uncompensateScroll(a),
                                this.dayGrid && (this.dayGrid.removeSegPopover(), (r = this.opt("eventLimit")), r && "number" != typeof r && (r = 5), r && this.dayGrid.limitRows(r)),
                                n ||
                    ...
                    renderHeadIntroHtml: function () {
                        ...
                        return this.opt("weekNumbers")
                            ? ((t = i.format(this.opt("smallWeekFormat"))),
                              '<th class="fc-axis fc-week-number ' + n.theme.getClass("widgetHeader") + '" ' + e.axisStyleAttr() + ">" + e.buildGotoAnchorHtml({ date: i, type: "week", forceOff: this.colCnt > 1 }, u.htmlEscape(t)) + "</th>")
                    ...
                    return (
                        ...
                        (e.prototype.sliceRangeByTimes = function (t) {
                            var e,
                                n,
                                i = [];
                            for (n = 0; n < this.daysPerRow; n++) (e = t.intersect(this.dayRanges[n])) && i.push({ startMs: e.startMs, endMs: e.endMs, isStart: e.isStart, isEnd: e.isEnd, dayIndex: n });
                            return i;
                        }),
        ...
        function (t, e, n) {
            ...
            var i = n(2),
                ...
                c = (function (t) {
                    function e(e, n) {
                        var i = t.call(this, e, n) || this;
                        return (i.segSelector = ".fc-list-item"), (i.scroller = new l.default({ overflowX: "hidden", overflowY: "auto" })), i;
                    }
                    return (
                        i.__extends(e, t),
                        (e.prototype.renderSkeleton = function () {
                        ...
                        (e.prototype.componentFootprintToSegs = function (t) {
                            ...
                            for (e = 0; e < r.length; e++)
                                if (
                                    ...
                                    ((i = { startMs: n.startMs, endMs: n.endMs, isStart: n.isStart, isEnd: n.isEnd, dayIndex: e }),
                                    o.push(i),
                        ...
                        this.each(function (r, a) {
                            ...
                            "string" == typeof t
                                ? "getCalendar" === t
                                    ...
                                    : d
                                    ? i.isFunction(d[t])
                                        ? ((l = d[t].apply(d, e)), r || (n = l), "destroy" === t && u.removeData("fullCalendar"))
                    ...
                    return (
                        ...
                        (t.prototype.render = function () {
                            var t = this.toolbarOptions.layout,
                                e = this.el;
                            t
                                ? (e ? e.empty() : (e = this.el = i("<div class='fc-toolbar " + this.toolbarOptions.extraClasses + "'/>")),
                                ...
                                u &&
                                    i.each(u.split(" "), function (t, s) {
                                        ...
                                        i.each(s.split(","), function (t, s) {
                                            ...
                                            "title" === s
                                                ...
                                                : ((l = d[s])
                                                  ...
                                                  g &&
                                                      ...
                                                      y ? ((m = r.htmlEscape(y)), (D = "")) : v && ((m = "<span class='" + v + "'></span>"), (D = ' aria-label="' + s + '"')),
                                                      (w = i('<button type="button" class="' + b.join(" ") + '"' + D + ">" + m + "</button>")
                                                          .click(function (t) {
                                            ...
                                            h.length > 1 ? ((u = i("<div/>")), f && u.addClass(o.getClass("buttonGroup")), u.append(h), l.append(u)) : l.append(h);
                                    }),
                                l
                            );
                        }),
                        ...
                        (t.prototype.buildViewSpec = function (t) {
                            for (var e, n, r, l, u, d = this.optionsManager.overrides.views || {}, c = [], p = [], h = [], f = t; f; )
                                (e = o.viewHash[f]),
                                    ...
                                    e && (c.unshift(e), p.unshift(e.defaults || {}), (r = r || e.duration), (f = f || e.type)),
                                    n && (h.unshift(n), (r = r || n.duration), (f = f || n.type));
                            return (
                                (e = s.mergeProps(c)),
                                (e.type = t),
                                !!e.class &&
                                    ((r = r || this.optionsManager.dynamicOverrides.duration || this.optionsManager.overrides.duration),
                                    r && ((l = i.duration(r)), l.valueOf() && ((u = s.computeDurationGreatestUnit(l, r)), (e.duration = l), (e.durationUnit = u), 1 === l.as(u) && ((e.singleUnit = u), h.unshift(d[u] || {})))),
                ...
                u = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.purgeSource = function (t) {
                            ...
                            e &&
                                (delete this.requestsByUid[t.uid], "pending" === e.status ? ((e.status = "cancelled"), this.pendingCnt--, this.tryRelease()) : "completed" === e.status && e.eventDefs.forEach(this.removeEventDef.bind(this)));
                        }),
                ...
                s = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.stop = function (t, e) {
                            ...
                            this.isFollowing &&
                                !this.isAnimating &&
                                ((this.isFollowing = !1), this.stopListeningTo(i(document)), t && r && !this.isHidden ? ((this.isAnimating = !0), this.el.animate({ top: this.top0, left: this.left0 }, { duration: r, complete: o })) : o());
                        }),
                        (t.prototype.getEl = function () {
                            var t = this.el;
                            return (
                                t ||
                                    ((t = this.el = this.sourceEl
                                        .clone()
                    ...
                    return (
                        ...
                        (e.prototype.fgSegHtml = function (t, e) {
                            ...
                            return (
                                ...
                                (n ? '<div class="fc-time" data-start="' + u.htmlEscape(r) + '" data-full="' + u.htmlEscape(i) + '"><span>' + u.htmlEscape(n) + "</span></div>" : "") +
                        ...
                        (e.prototype.computeFgSegForwardBack = function (t, e, n) {
                            ...
                            if (void 0 === t.forwardCoord)
                                for (
                                    r.length ? (this.sortForwardSegs(r), this.computeFgSegForwardBack(r[0], e + 1, n), (t.forwardCoord = r[0].backwardCoord)) : (t.forwardCoord = 1),
                    ...
                    return (
                        ...
                        (e.prototype.attachSegEls = function (t, e) {
                            var n,
                                i = this.component;
                            return (
                                "bgEvent" === t ? (n = i.bgContainerEls) : "businessHours" === t ? (n = i.businessContainerEls) : "highlight" === t && (n = i.highlightContainerEls),
                        ...
                        (t.prototype.position = function () {
                            ...
                            (o = a.top || 0),
                                ...
                                !1 !== a.viewportConstrain &&
                                    ((o = Math.min(o, t + p.outerHeight() - d - this.margin)), (o = Math.max(o, t + this.margin)), (s = Math.min(s, e + p.outerWidth() - u - this.margin)), (s = Math.max(s, e + this.margin))),
                        ...
                        (e.prototype.fgSegHtml = function (t) {
                            ...
                            return (
                                (e = l.isAllDay
                                    ...
                                    ? t.isStart || t.isEnd
                                        ? r.htmlEscape(this._getTimeText(i.msToMoment(t.startMs), i.msToMoment(t.endMs), l.isAllDay))
                                        : n.getAllDayHtml()
        ...
        function (t, e, n) {
            ...
            i.defineView("basic", { class: r.default }),
                ...
                i.defineView("month", { class: o.default, duration: { months: 1 }, defaults: { fixedWeekCount: !0 } });
        },
        function (t, e, n) {
            Object.defineProperty(e, "__esModule", { value: !0 });
            var i = n(22),
                r = n(226);
            i.defineView("agenda", { class: r.default, defaults: { allDaySlot: !0, slotDuration: "00:30:00", slotEventOverlap: !0 } }),
        ...
        function (t, e, n) {
            ...
            var i = n(22),
                r = n(230);
            i.defineView("list", { class: r.default, buttonTextKey: "list", defaults: { buttonText: "list", listDayFormat: "LL", noEventsMessage: "No events to display" } }),
                i.defineView("listDay", { type: "list", duration: { days: 1 }, defaults: { listDayFormat: "dddd" } }),
                i.defineView("listWeek", { type: "list", duration: { weeks: 1 }, defaults: { listDayFormat: "dddd", listDayAltFormat: "LL" } }),
                i.defineView("listMonth", { type: "list", duration: { month: 1 }, defaults: { listDayAltFormat: "dddd" } }),
