...
<div class="tab-pane fade" id="custom-tabs-four-dasede" role="tabpanel" aria-labelledby="custom-tabs-four-dasede-tab">
<!-- 매물 주소 api 활용-->
	<div>
		<li style="margin-right: 10px; margin-top: 10px;"> 매물 주소(다세대/빌라) </li>
	...
	<div class="form-group row" >
		<li style="margin-right: 20px; margin-left: 7.5px; margin-top: 5px;">계약 유형 </li> 
			<div class="icheck-primary d-inline">
				<input type="radio" id="contract_type31" name="contract_type" value="매매" checked>
				<label for="contract_type31">
				매매
				</label>
			</div>
			
			<div class="icheck-primary d-inline">
				<input type="radio" id="contract_type32" name="contract_type" value="전세" >
				<label for="contract_type32">
				전세
				</label>
			</div>
	                      			
			<div class="icheck-primary d-inline">
				<input type="radio" id="contract_type33" name="contract_type" value="월세" >
				<label for="contract_type33">
				월세
				</label>
			</div>
	</div>
