	...
	<div class="form-group row" >
		<li style="margin-right: 20px; margin-left: 7.5px; margin-top: 5px;">계약 유형 </li> 
			<div class="icheck-primary d-inline">
				<input type="radio" id="contract_type21" name="contract_type" value="매매" checked>
				<label for="contract_type21">
				매매
				</label>
			</div>
			
			<div class="icheck-primary d-inline">
				<input type="radio" id="contract_type22" name="contract_type" value="전세" >
				<label for="contract_type22">
				전세
				</label>
			</div>
	                      			
			<div class="icheck-primary d-inline">
				<input type="radio" id="contract_type23" name="contract_type" value="월세" >
				<label for="contract_type23">
				월세
				</label>
			</div>
	</div>
